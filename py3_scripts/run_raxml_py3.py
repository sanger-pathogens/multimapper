...
if __name__ == "__main__":
	...
	print(taxacount, alnlen-len(toremove), file=output_handle)
	for seq in alignment:
		newseq=[]
		for x, base in enumerate(alignment[seq]):
			if not x in toremove:
				newseq.append(base)
		print(seq, ''.join(newseq), file=output_handle)
		print(">"+seq, file=fasta_output_handle)
		print(''.join(newseq), file=fasta_output_handle)
